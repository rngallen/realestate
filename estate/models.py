...
class House(models.Model):
    ...
    category = models.ForeignKey(
        "estate.Category", verbose_name=_("Category"), on_delete=models.CASCADE
    )
    ...
    update = models.DateTimeField(_("Updated"), auto_now=True, auto_now_add=False)
    property_type = models.CharField(
        _("Propery Type"),
        max_length=50,
    )
    furnished = models.BooleanField(_("Furnished"), default=False)
    exchange_posibility = models.BooleanField(_("Exchange Possibilty"), default=False)
    realtor_fee = models.BooleanField(_("Realtor Fee"), default=True)

    image1 = models.ImageField(_("Main Image"), upload_to=upload_path)
    image2 = models.ImageField(_("Image"), upload_to=upload_path, blank=True, null=True)
    image3 = models.ImageField(_("Image"), upload_to=upload_path, blank=True, null=True)
    image4 = models.ImageField(_("Image"), upload_to=upload_path, blank=True, null=True)
    image5 = models.ImageField(_("Image"), upload_to=upload_path, blank=True, null=True)
    image6 = models.ImageField(_("Image"), upload_to=upload_path, blank=True, null=True)
    image7 = models.ImageField(_("Image"), upload_to=upload_path, blank=True, null=True)
    is_published = models.BooleanField(_("Is Published"), default=True)
    posted = models.DateTimeField(_("Posted"), auto_now=False, auto_now_add=True)
